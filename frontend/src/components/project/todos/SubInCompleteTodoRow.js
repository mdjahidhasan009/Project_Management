...
const SubInCompleteTodoRow = ({ subTodo, projectId, todoId, toggleSubTodoIsDone, username, deleteSubTodo,
...
export default connect(mapStateToProps, { toggleSubTodoIsDone, deleteSubTodo })(SubInCompleteTodoRow);
