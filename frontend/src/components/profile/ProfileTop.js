...
const ProfileTop = ({ user, match, loadedUser, getUserByUserName }) => {
    ...
    return (
        <div className="main">
            ...
            {/*<div className="profile_div profile-about">*/}
                {loadedUser
                ? (loadedUser.bio && (
                        <div className="profile_div profile-bio">
                ...
                ? (loadedUser.skills && loadedUser.skills.length > 0 && (
                    <div className="profile_div profile-skills">
                        <h4 >Skill Set</h4>
...
export default connect(mapStateToProps, { getUserByUserName })(ProfileTop);
