...
//             VITE_ASSET_URL +'/api/project/' + projectId,
//             'PUT',
//             JSON.stringify({
//                 name: projectName,
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/discussion/' + projectId,
//             'POST',
//             JSON.stringify({
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/discussion/' + projectId + '/' + discussionId,
//             'PUT',
//             JSON.stringify({
//                 discussionEditText
//             }),
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/assignTodo/todos/' + projectId + '/' + username,
//             'POST',
//             JSON.stringify({
//                 todo: todoText
//             }),
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/todos/' + projectId,
//             'POST',
//             JSON.stringify({
//                 todo: todoText
//             }),
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/toggle/todos/' + projectId + '/' + todoId,
//             'PUT',
//             JSON.stringify({
//                 isDone: isDone
//             }),
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/todos/' + projectId + '/' + todoId,
//             'PUT',
//             JSON.stringify({
//                 todoEditText
//             }),
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/todos/' + projectId + '/todoId/' + todoId,
//             'POST',
//             JSON.stringify({
//                 todo: todoText,
//                 todoId: todoId
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/toggle/todos/' + projectId + '/' + todoId + '/' + subTodoId,
//             'PUT',
//             JSON.stringify({
//                 isDone: isDone
//             }),
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/todos/' + projectId + '/' + todoId + '/' + subTodoId,
//             'PUT',
//             JSON.stringify({
//                 subTodoEditText
//             }),
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/bugs/' + projectId + '/' + bugId,
//             'POST',
//             JSON.stringify({
//                 isFixed: isFixed
//             }),
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL +'/api/project/bugs/' + projectId,
//             'POST',
//             JSON.stringify({
//                 bug: bugText
//             }),
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL + '/api/user/project/' + projectId,
//             'GET',
//             null,
//             {
//                 'Authorization': 'Bearer ' + localStorage.token
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL + '/api/project/member/' + projectId,
//             'POST',
//             JSON.stringify({
//                 username
//             }),
...
//     try {
//         const responseData = await method(
//             VITE_ASSET_URL + '/api/project/memberorcreator/' + projectId,
//             'GET',
//             null,
//             {
//                 'Authorization': 'Bearer ' + localStorage.token
...
// export const prepareTodoAndBugForPreview = createAsyncThunk(
//     'project/prepareTodoAndBugForPreview',
//     async ({ username, projects }, { rejectWithValue }) => {
//         let allCompletedActivity = [];
//         let allNotCompletedActivity = [];
//         let projectName = null;
//         let completedTodoOfAProject = []; //completed todo of a single project of a member
...
//                 notFixedBug: notFixedBugCount
//             }
//             return { chartData, activitySummary: { completedActivity: allCompletedActivity, notCompletedActivity: allNotCompletedActivity }, todoBugCountSummary };
//         } catch (error) {
//             return rejectWithValue(error.message);
//         }
//     }
